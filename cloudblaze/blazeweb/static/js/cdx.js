...
(function() {
  ...
  window.setup_ipython_events = function() {
    IPython.Kernel.prototype.namespace_request = function() {
      var content, msg;
      content = {};
      msg = this.get_msg("namespace_request", content);
      this.shell_channel.send(JSON.stringify(msg));
      return msg.header.msg_id;
    };
    IPython.Eventer = _.clone(Backbone.Events);
    return IPython.Eventer.on('shellmsg:namespace', function(header, content) {
      ...
      load_doc: function(docid) {
        ...
        return docdata = $.get("/cdxinfo/" + docid, {}, function(data) {
          ...
          _.delay(function() {
            ...
            return window.setup_ipython_events();
          }, 1000);
